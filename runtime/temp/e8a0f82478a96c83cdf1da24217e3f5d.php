<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./template/pc/rainbow/goods\goodsInfo.html";i:1504413931;s:40:"./template/pc/rainbow/public\header.html";i:1499420874;s:46:"./template/pc/rainbow/public\footer_index.html";i:1499420874;s:46:"./template/pc/rainbow/public\sidebar_cart.html";i:1499420874;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="pic-hide-box fl">
                            <ul class="small-pic" style="left:0;">
                                <?php if(is_array($goods_images_list) || $goods_images_list instanceof \think\Collection || $goods_images_list instanceof \think\Paginator): if( count($goods_images_list)==0 ) : echo "" ;else: foreach($goods_images_list as $k=>$v): ?>
                                    ...
                                    <a href="javascript:;">
                                        <img src="<?php echo get_sub_images($v,$v[goods_id],60,60); ?>"
                                             data-img="<?php echo get_sub_images($v,$v[goods_id],400,400); ?>"
                                             data-big="<?php echo get_sub_images($v,$v[goods_id],800,800); ?>">
                                        <i></i>
                                    </a>
                                    </li>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div class="detail-ggsl">
                    ...
                    <div class="presale-time">
                        ...
                        <script>
                            ...
                            function GetRTime2() {
                                ...
                                var text = GetRTime('<?php echo date("Y/m/d H:i:s",$goods['
                                flash_sale
                                ']['
                                end_time
                                ']); ?>'
                ...
                <div class="shop-price-cou">
                    <div class="shop-price-le">
                        <ul>
                            <li class="jaj"><span><?php if($goods['prom_type'] == 1): ?> 优惠价：<?php else: ?>商城价：<?php endif; ?></span>
                            </li>
                            <li>
                ...
                <?php if($goods['exchange_integral'] > 0): ?>
                    <div class="standard p">
                        <ul>
                            ...
                            <li class="lawir"><span class="service"><?php echo $goods['shop_price']-$goods['exchange_integral']/$point_rate; ?>+<?php echo $goods['exchange_integral']; ?>积分</span>
                            </li>
                        </ul>
                    </div>
                <?php endif; ?>
                            ...
                            <ul>
                                ...
                                <li class="lawir colo">
                                    <?php if(is_array($v) || $v instanceof \think\Collection || $v instanceof \think\Paginator): if( count($v)==0 ) : echo "" ;else: foreach($v as $k2=>$v2): if($v2[src] != ''): ?>
                                            <input type="radio" style="display: none" rel="<?php echo $v2[item]; ?>"
                                                   name="goods_spec[<?php echo $k; ?>]" value="<?php echo $v2[item_id]; ?>"
                                            <?php if($k2 == 0): ?>checked="checked"<?php endif; ?>
                                            />
                                            <a onclick="switch_zooming('<?php echo $v2[src]; ?>');select_filter(this); <?php if(!empty($v2[src])): ?> $('#zoomimg').attr('src','<?php echo $v2[src]; ?>')
                                        <?php endif; ?>
                                        "
                                        <?php if($k2 == 0): ?> class="red"<?php endif; ?>
                                        >
                        ...
                        <li class="lawir">
                            <div class="minus-plus">
                                ...
                                <input class="buyNum" id="number" type="text" name="goods_num" value="1"
                                       onblur="altergoodsnum(0)" max="<?php if(empty($goods['flash_sale']) || (($goods['flash_sale'] instanceof \think\Collection || $goods['flash_sale'] instanceof \think\Paginator ) && $goods['flash_sale']->isEmpty())): ?><?php echo $goods['store_count']; else: ?>
                                <?php echo $goods['flash_sale']['goods_num']-$goods['flash_sale']['buy_num']; endif; ?>"/>
                                <a class="add" href="javascript:void(0);" onclick="altergoodsnum(1)">+</a>
                            </div>
                            <div class="sav_shop">剩余库存：<span id="store_count"><?php if(empty($goods['flash_sale']) || (($goods['flash_sale'] instanceof \think\Collection || $goods['flash_sale'] instanceof \think\Paginator ) && $goods['flash_sale']->isEmpty())): ?><?php echo $goods['store_count']-1; else: ?><?php echo $goods['flash_sale']['goods_num']-$goods['flash_sale']['buy_num']-1; endif; ?></span>
                            </div>
                        </li>
                    </ul>
                    <script>
                ...
                <div class="standard p">
                    ...
                    <a class="addcar" href="javascript:;" onclick="AjaxAddCart(<?php echo $goods['goods_id']; ?>,1,0);"><i
                            class="sk"></i>加入购物车</a>
                </div>
            </div>
        </form>
                                ...
                                <li class="co-cen">
                                    <div class="comm_gooba">
                                        <div class="gg_c">
                                            ...
                                            <span class="zz_rg"><i
                                                    style="width: <?php echo $commentStatistics['rate1']; ?>%;"></i></span>
                                        </div>
                                        <div class="gg_c">
                                            <span class="hps">中评</span>
                                            <span class="hp">（<?php echo $commentStatistics['rate2']; ?>%）</span>
                                            <span class="zz_rg"><i
                                                    style="width: <?php echo $commentStatistics['rate2']; ?>%;"></i></span>
                                        </div>
                                        <div class="gg_c">
                                            <span class="hps">差评</span>
                                            <span class="hp">（<?php echo $commentStatistics['rate3']; ?>%）</span>
                                            <span class="zz_rg"><i
                                                    style="width: <?php echo $commentStatistics['rate3']; ?>%;"></i></span>
                                        </div>
                                    </div>
                                </li>
                                <li class="tjd-sum">
                                ...
                                <ul id="fy-comment-list">
                                    <li data-t="1" class="red">
                                        <a href="javascript:void(0);"
                                           class="selected">全部评论（<?php echo $commentStatistics['c0']; ?>）</a>
                                    </li>
                                    <li data-t="2">
...
<div style="display: none" id="look_see">
    <?php if(is_array($look_see) || $look_see instanceof \think\Collection || $look_see instanceof \think\Paginator): if( count($look_see)==0 ) : echo "" ;else: foreach($look_see as $k=>$look): ?>
        <div class="tjhot-shoplist type-bot">
            <div class="alone-shop">
                <a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$look[goods_id])); ?>"><img class="wiahides"
                                                                                         src="<?php echo goods_thum_images($look['goods_id'],206,206); ?>"
...
<script type="text/javascript">
    ...
    function get_goods_price() {
        var goods_price = <?php echo $goods['shop_price']; ?>
        ; // 商品起始价
        var store_count = <?php echo $goods['store_count']; ?>
        ; // 商品起始库存
