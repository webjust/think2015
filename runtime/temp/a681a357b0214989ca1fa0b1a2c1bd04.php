<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"./template/pc/rainbow/user\comment.html";i:1499420874;s:38:"./template/pc/rainbow/user\header.html";i:1499420874;s:36:"./template/pc/rainbow/user\menu.html";i:1499420874;s:46:"./template/pc/rainbow/public\footer_index.html";i:1499420874;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
												...
												<td class="sx6">
													<div class="rbac">
														<?php if($list['is_comment'] == 1): ?>
															...
															<?php else: ?>
															<p class="inspect"><a href="<?php echo U('Home/User/comment_list',array('order_id'=>$list['order_id'],'goods_id'=>$list['goods_id'])); ?>">评价</a>
														<?php endif; ?>
