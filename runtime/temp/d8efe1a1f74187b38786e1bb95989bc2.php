            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <select name="auto_confirm_date" id="distribut_date">
                        <?php $__FOR_START_14347__=1;$__FOR_END_14347__=31;for($i=$__FOR_START_14347__;$i < $__FOR_END_14347__;$i+=1){ ?>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <select name="auto_service_date" id="auto_service_date">
                        <?php $__FOR_START_23514__=1;$__FOR_END_23514__=31;for($i=$__FOR_START_23514__;$i < $__FOR_END_23514__;$i+=1){ ?>
