<?php
//000000000000s:13927:"<script src="/public/js/viewer/viewer.min.js"></script>
...
<div class="people-comment">
        ...
        <div class="person-com">
            ...
            <div class="lifr4 p">
                <div class="dstar start5">
                   <i class="start start1" style="width:20%"></i>
                </div>
            </div>
            ...
            <div class="lifr4 requiimg p">
                <ul class="comment_images" id="comment_images_163">
                                            <a><li><img data-original="/public/upload/goods/2016/01-15/56986502e0a52.jpg" src="/public/upload/goods/2016/01-15/56986502e0a52.jpg"/></li></a>
                                            <a><li><img data-original="/public/upload/goods/2016/01-15/56986502c6e5a.jpg" src="/public/upload/goods/2016/01-15/56986502c6e5a.jpg"/></li></a>
                                            <a><li><img data-original="/public/upload/goods/2016/01-15/56986502a475c.jpg" src="/public/upload/goods/2016/01-15/56986502a475c.jpg"/></li></a>
                                    </ul>
                <script>
                    var viewer = new Viewer(document.getElementById('comment_images_163'), {
                        url: 'data-original',
                        show: function() {
                            $('.soubao-sidebar').hide();
                        },
    ...
    <!--点赞，回复-->
        <div class="g_come">
            ...
            <a  onclick="zan(this);"  data-comment-id="163"><i class="detai-ico z-ten"></i><span id="span_zan_163" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        ...
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_163" placeholder="回复 ：" maxlength="120"></textarea>-->
...
<div class="people-comment">
    <div class="deta-descri p">
        ...
        <div class="person-com">
            ...
            <!--晒单图-->
            <div class="lifr4 requiimg p">
                <ul class="comment_images" id="comment_images_97">
                                    </ul>
                <script>
                    var viewer = new Viewer(document.getElementById('comment_images_97'), {
                        url: 'data-original',
                        show: function() {
                            $('.soubao-sidebar').hide();
                        },
    ...
    <!--点赞，回复-->
        <div class="g_come">
            <a href="javascript:void(0);"><i class="detai-ico c-cen"></i>0</a>
            <a  onclick="zan(this);"  data-comment-id="97"><i class="detai-ico z-ten"></i><span id="span_zan_97" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        <!--<div class="reply-arrow"><b class="layer1"></b><b class="layer2"></b></div>-->
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_97" placeholder="回复 ：" maxlength="120"></textarea>-->
            <!--<div class="operate-box">-->
                <!--<span class="txt-countdown">还可以输入<em>120</em>字</span>-->
                <!--<a class="reply-submit J-submit-reply J-submit-reply-lz" href="javascript:void(0);" target="_self">提交</a>-->
            <!--</div>-->
...
<div class="people-comment">
    <div class="deta-descri p">
        ...
        <div class="person-com">
            ...
            <!--晒单图-->
            <div class="lifr4 requiimg p">
                <ul class="comment_images" id="comment_images_31">
                                    </ul>
                <script>
                    var viewer = new Viewer(document.getElementById('comment_images_31'), {
                        url: 'data-original',
                        show: function() {
                            $('.soubao-sidebar').hide();
                        },
    ...
    <!--点赞，回复-->
        <div class="g_come">
            <a href="javascript:void(0);"><i class="detai-ico c-cen"></i>0</a>
            <a  onclick="zan(this);"  data-comment-id="31"><i class="detai-ico z-ten"></i><span id="span_zan_31" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        <!--<div class="reply-arrow"><b class="layer1"></b><b class="layer2"></b></div>-->
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_31" placeholder="回复 ：" maxlength="120"></textarea>-->
            <!--<div class="operate-box">-->
                <!--<span class="txt-countdown">还可以输入<em>120</em>字</span>-->
                <!--<a class="reply-submit J-submit-reply J-submit-reply-lz" href="javascript:void(0);" target="_self">提交</a>-->
            <!--</div>-->
