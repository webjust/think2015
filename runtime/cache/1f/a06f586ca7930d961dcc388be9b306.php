<?php
//000000000000s:152065:"<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>商品列表</title>
...
<div class="search-box p">
	<div class="w1430">
		<div class="search-path fl">
			<a href="/index.php/Home/Goods/goodsList/id/154.html">全部结果</a>
			<i class="litt-xyb"></i>
							<a href="/index.php/Home/Goods/goodsList/id/24.html">电脑、办公</a>
						<i class="litt-xyb"></i>
			<!--如果当前分类是三级分类 则二级也要显示-->
							<div class="havedox">
					<div class="disenk"><span>网络产品</span><i class="litt-xxd"></i></div>
					<div class="hovshz">
						<ul>
																<li><a href="/index.php/Home/Goods/goodsList/id/24.html">网络产品</a></li>
																	<li><a href="/index.php/Home/Goods/goodsList/id/25.html">办公设备</a></li>
																	<li><a href="/index.php/Home/Goods/goodsList/id/26.html">文具耗材</a></li>
																	<li><a href="/index.php/Home/Goods/goodsList/id/27.html">电脑整机</a></li>
																	<li><a href="/index.php/Home/Goods/goodsList/id/28.html">电脑配件</a></li>
																	<li><a href="/index.php/Home/Goods/goodsList/id/29.html">外设产品</a></li>
																	<li><a href="/index.php/Home/Goods/goodsList/id/30.html">游戏设备</a></li>
														</ul>
					</div>
				</div>
				<i class="litt-xyb"></i>
			...
			<span><a href="/index.php/Home/Goods/goodsList/id/154.html">清空筛选条件</a></span>
		</div>
	</div>
</div>
<!-- 筛选 start -->
		...
		<div class="stsho fr">
			<div class="sx_topb ba-dark-bg">
				<div class="f-sort fl">
					<ul>
						<li class="red">
                            <a href="/index.php/Home/Goods/goodsList/id/154">综合</a>
                        </li>
						<li class="">
                            <a href="/index.php/Home/Goods/goodsList/id/154/sort/sales_sum">销量</a>
                        </li>
													<li class="">
                                <a href="/index.php/Home/Goods/goodsList/id/154/sort/shop_price/sort_asc/desc">价格<i class="litt-zzx1"></i></a>
                            </li>
												<li class="">
                            <a href="/index.php/Home/Goods/goodsList/id/154/sort/comment_count">评论</a>
                        </li>
						<li class="">
                            <a href="/index.php/Home/Goods/goodsList/id/154/sort/is_new">新品</a>
                        </li>
					</ul>
				</div>
