<?php
//000000000000s:192179:"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>商品详情</title>
                ...
                <div class="product-gallery">
                    <div class="product-photo" id="photoBody">
                        ...
                        <div class="product-img jqzoom">
                            <img id="zoomimg" src="/public/upload/goods/thumb/45/goods_thumb_45_400_400.jpeg" jqimg="/public/upload/goods/thumb/45/goods_thumb_45_800_800.jpeg">
                        </div>
                        <!-- 商品大图介绍 end ]]-->
                        <!-- 商品小图介绍 start [[-->
                        <div class="product-small-img fn-clear"> <a href="javascript:;" class="next-left next-btn fl disabled"></a>
                            <div class="pic-hide-box fl">
                                <ul class="small-pic" style="left:0;">
                                        ...
                                        <a href="javascript:;">
                                            <img src="/public/upload/goods/thumb/45/goods_sub_thumb_110_60_60.jpeg" data-img="/public/upload/goods/thumb/45/goods_sub_thumb_110_400_400.jpeg" data-big="/public/upload/goods/thumb/45/goods_sub_thumb_110_800_800.jpeg">
                                            <i></i>
                                        </a>
                                        </li>
                                                                            <li class="small-pic-li ">
                                        <a href="javascript:;">
                                            <img src="/public/upload/goods/thumb/45/goods_sub_thumb_111_60_60.jpeg" data-img="/public/upload/goods/thumb/45/goods_sub_thumb_111_400_400.jpeg" data-big="/public/upload/goods/thumb/45/goods_sub_thumb_111_800_800.jpeg">
                                            <i></i>
                                        </a>
                                        </li>
                                                                            <li class="small-pic-li ">
                                        <a href="javascript:;">
                                            <img src="/public/upload/goods/thumb/45/goods_sub_thumb_112_60_60.jpeg" data-img="/public/upload/goods/thumb/45/goods_sub_thumb_112_400_400.jpeg" data-big="/public/upload/goods/thumb/45/goods_sub_thumb_112_800_800.jpeg">
                                            <i></i>
                                        </a>
                                        </li>
                                                                            <li class="small-pic-li ">
                                        <a href="javascript:;">
                                            <img src="/public/upload/goods/thumb/45/goods_sub_thumb_113_60_60.jpeg" data-img="/public/upload/goods/thumb/45/goods_sub_thumb_113_400_400.jpeg" data-big="/public/upload/goods/thumb/45/goods_sub_thumb_113_800_800.jpeg">
                                            <i></i>
                                        </a>
                                        </li>
                                                                    </ul>
            ...
            <form id="buy_goods_form" name="buy_goods_form" method="post" >
                ...
                <div class="shop-price-cou">
                    ...
                    <div class="shop-cou-ri">
                        <div class="allcomm"><p>累计评价</p><p class="f_blue">4</p></div>
                        <div class="br1"></div>
                ...
                <div class="standard p">
                    <ul>
                        ...
                        <ul>
                            ...
                            <li class="lawir"><span class="service">1899+100积分</span></li>
                        </ul>
                    </div>
                ...
                <!-- 规格 start [[-->
                            ...
                            <ul>
                                ...
                                <li class="lawir colo">
                                                                            <input type="radio" style="display: none" rel="16G" name="goods_spec[内存]" value="13"  checked="checked"/>
                                        <a   onclick="select_filter(this);"  class="red">16G</a>
                                                                            <input type="radio" style="display: none" rel="8G" name="goods_spec[内存]" value="14"  />
                                        <a   onclick="select_filter(this);" >8G</a>
                                                                            <input type="radio" style="display: none" rel="32G" name="goods_spec[内存]" value="28"  />
                            ...
                            <ul>
                                ...
                                <li class="lawir colo">
                                                                            <input type="radio" style="display: none" rel="触屏" name="goods_spec[屏幕]" value="21"  checked="checked"/>
                                        <a   onclick="select_filter(this);"  class="red">触屏</a>
                                                                    </li>
                            </ul>
                        </div>
                                    <script>
                    ...
                    <ul>
                        ...
                        <li class="lawir">
                            <div class="minus-plus">
                                ...
                                <input class="buyNum" id="number" type="text" name="goods_num" value="1" onblur="altergoodsnum(0)" max="299"/>
                                <a class="add" href="javascript:void(0);" onclick="altergoodsnum(1)">+</a>
                            </div>
                            <div class="sav_shop">剩余库存：<span id="store_count">298</span></div>
                        </li>
                    </ul>
                    <script>
                        $('#number').val(1);
                ...
                <div class="standard p">
                    ...
                    <a class="addcar" href="javascript:;" onclick="AjaxAddCart(45,1,0);"><i class="sk"></i>加入购物车</a>
                </div>
            </div>
            </form>
            <!--看了又看-s-->
